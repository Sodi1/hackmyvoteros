...
import static com.rosatom.myvote.service.langchecker.Characters.isAbbreviation;
import static com.rosatom.myvote.service.langchecker.Characters.isSeparator;
import static com.rosatom.myvote.service.langchecker.Characters.isSeparatorOrPossibleRu;
import static com.rosatom.myvote.service.langchecker.Characters.restoreUppercase;
import static com.rosatom.myvote.service.langchecker.Characters.uppercasePositions;
...
public final class LangSwitcherTokenizer implements Tokenizer {
  ...
  LangSwitcherTokenizer(LangChecker langChecker, int minTokenLength) {
    ...
    try {
      this.exceptions = Resources.readLines(
              Resources.getResource("dictionary/exceptions.csv"),
              Charsets.UTF_8,
  ...
  public TokenizerResponse tokenize(String input) {
    ...
    List<String> wordTokens = allTokens.stream()
            .filter(TokenFunctions.isWord()).map(TokenFunctions.corrected())
            .toList();
