...
from myvote_analytics.db.utils import create_database, drop_database
from myvote_analytics.services.rabbit.dependencies import get_rmq_channel_pool
from myvote_analytics.services.rabbit.lifetime import init_rabbit, shutdown_rabbit
from myvote_analytics.services.redis.dependency import get_redis_pool
from myvote_analytics.settings import settings
from myvote_analytics.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from myvote_analytics.db.meta import meta  # noqa: WPS433
    from myvote_analytics.db.models import load_all_models  # noqa: WPS433
